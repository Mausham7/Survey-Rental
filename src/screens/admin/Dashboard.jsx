            ...
            <div>
              {products && products.length > 0 && products.map((details, index) => (
                <div key={index} className='p-5 flex border-b border-b-gray-200'>
                  <h2 className='w-[25%]'>{details.pName || 'N/A'}</h2>
                  ...
                  <h2 className='w-[15%]'>
                    <input
                      type="number"
                      value={details.stock}
                      onChange={(e) => updateStock(details._id, e.target.value)}
          ...
          <div className='bg-white p-10 rounded-lg shadow-lg w-[60%]'>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              >
                ...
                <option value='Survey Tripod'>Survey Tripod</option>
